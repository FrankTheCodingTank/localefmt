...
assert.equal(formatPhone('+12125550199', 'en-US', true), '+1 (212) 555-0199');
...
assert.equal(parsePhone(formatPhone('+12125550199', 'en-US', { includeCode: true }), 'en-US'), '+12125550199');
...
assert.equal(parsePhone('(416) 555-0137', 'en-US'), '+14165550137');
