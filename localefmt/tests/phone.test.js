...
assert.equal(formatPhone('+14165550137', 'en-CA', true), '+1 (416) 555-0137');
...
assert.equal(parsePhone(formatPhone('00442071234567', 'en-GB', { includeCode: true }), 'en-GB'), '+442071234567');
...
assert.equal(parsePhone('+1 (242) 555-0199', 'en-CA'), '+12425550199');
